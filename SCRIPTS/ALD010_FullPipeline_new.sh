#!/bin/bash
#PBS -N ALD010_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-data04/PROCESS/ALD_GENOME/ALD010/ALD010new.o
#PBS -e /mnt/causes-data04/PROCESS/ALD_GENOME/ALD010/ALD010new.e
#PBS -m bea
...
SAMPLE_ID='ALD010_BWAmem'
WORKING_DIR='/mnt/causes-data04/PROCESS/ALD_GENOME/ALD010/'
FASTQR1='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD010/ALD010_R1.fastq.gz'
FASTQR2='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD010/ALD010_R2.fastq.gz'
