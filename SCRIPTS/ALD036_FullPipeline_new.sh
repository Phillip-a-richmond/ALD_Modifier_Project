#!/bin/bash
#PBS -N ALD036_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-data04/PROCESS/ALD_GENOME/ALD036/ALD036new.o
#PBS -e /mnt/causes-data04/PROCESS/ALD_GENOME/ALD036/ALD036new.e
#PBS -m bea
...
SAMPLE_ID='ALD036_BWAmem'
WORKING_DIR='/mnt/causes-data04/PROCESS/ALD_GENOME/ALD036/'
FASTQR1='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD036/ALD036_R1.fastq.gz'
FASTQR2='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD036/ALD036_R2.fastq.gz'
