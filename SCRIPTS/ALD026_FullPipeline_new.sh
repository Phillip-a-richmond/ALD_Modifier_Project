#!/bin/bash
#PBS -N ALD026_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-data04/PROCESS/ALD_GENOME/ALD026/ALD026new.o
#PBS -e /mnt/causes-data04/PROCESS/ALD_GENOME/ALD026/ALD026new.e
#PBS -m bea
...
SAMPLE_ID='ALD026_BWAmem'
WORKING_DIR='/mnt/causes-data04/PROCESS/ALD_GENOME/ALD026/'
FASTQR1='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD026/ALD026_R1.fastq.gz'
FASTQR2='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD026/ALD026_R2.fastq.gz'
