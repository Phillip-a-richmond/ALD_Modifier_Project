#!/bin/bash
#PBS -N ALD042_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-data04/PROCESS/ALD_GENOME/ALD042/ALD042new.o
#PBS -e /mnt/causes-data04/PROCESS/ALD_GENOME/ALD042/ALD042new.e
#PBS -m bea
...
SAMPLE_ID='ALD042_BWAmem'
WORKING_DIR='/mnt/causes-data04/PROCESS/ALD_GENOME/ALD042/'
FASTQR1='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD042/ALD042_R1.fastq.gz'
FASTQR2='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD042/ALD042_R2.fastq.gz'
