#!/bin/bash
#PBS -N ALD058_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-data04/PROCESS/ALD_GENOME/ALD058/ALD058new.o
#PBS -e /mnt/causes-data04/PROCESS/ALD_GENOME/ALD058/ALD058new.e
#PBS -m bea
...
SAMPLE_ID='ALD058_BWAmem'
WORKING_DIR='/mnt/causes-data04/PROCESS/ALD_GENOME/ALD058/'
FASTQR1='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD058/ALD058_R1.fastq.gz'
FASTQR2='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD058/ALD058_R2.fastq.gz'
