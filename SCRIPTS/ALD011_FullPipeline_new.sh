#!/bin/bash
#PBS -N ALD011_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-data04/PROCESS/ALD_GENOME/ALD011/ALD011new.o
#PBS -e /mnt/causes-data04/PROCESS/ALD_GENOME/ALD011/ALD011new.e
#PBS -m bea
...
SAMPLE_ID='ALD011_BWAmem'
WORKING_DIR='/mnt/causes-data04/PROCESS/ALD_GENOME/ALD011/'
FASTQR1='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD011/ALD011_R1.fastq.gz'
FASTQR2='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD011/ALD011_R2.fastq.gz'
