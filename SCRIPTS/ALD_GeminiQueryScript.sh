...
GNOMAD_EXOME_RARE='((gnomad_exome_af_global <= 0.01) or (gnomad_exome_af_global is NULL))'
...
# De novo
echo "De novo	De novo (Strict)" >> $CVL_macro
...
echo "De novo	De novo (Loose)" >> $CVL_macro
#cat ${DENOVO_OUT_LOOSE}_annotated.txt >> $CVL_macro
perl -ne 'print "De novo\t$_" unless /^gene\s+Gene_Name\s+OMIM_Phenotypes/' ${DENOVO_OUT_LOOSE}_annotated.txt >> $CVL_macro
...
# Recessive
echo "Autosomal Rec (Homozygous)	Autosomal Rec (Homozygous) (strict)" >> $CVL_macro
...
echo "Autosomal Rec (Homozygous)	Autosomal Rec (Homozygous) (Loose)" >> $CVL_macro
#cat ${RECESSIVE_OUT_LOOSE}_annotated.txt >> $CVL_macro
perl -ne 'print "Autosomal Rec (Homozygous)\t$_" unless /^gene\s+Gene_Name\s+OMIM_Phenotypes/' ${RECESSIVE_OUT_LOOSE}_annotated.txt >> $CVL_macro
...
# Compound Het
echo "Recessive (Compound Het)	Compound Het (Strict)" >> $CVL_macro
...
echo "Recessive (Compound Het)	Compound Het (Loose)" >> $CVL_macro
#cat ${COMPOUND_HET_OUT_LOOSE}_annotated.txt >> $CVL_macro
perl -ne 'print "Recessive (Compound Het)\t$_" unless /^gene\s+Gene_Name\s+OMIM_Phenotypes/' ${COMPOUND_HET_OUT_LOOSE}_annotated.txt >> $CVL_macro
...
echo "Autosomal Dom (Heterozygous)	Autosomal Dominant (Loose)" >> $CVL_macro
#cat ${AUTODOM_OUT_LOOSE}_annotated.txt >> $CVL_macro
perl -ne 'print "Autosomal Dom (Heterozygous)\t$_" unless /^gene\s+Gene_Name\s+OMIM_Phenotypes/' ${AUTODOM_OUT_LOOSE}_annotated.txt >> $CVL_macro
...
# X de novo
echo "X De Novo	X De Novo (Strict)" >> $CVL_macro
...
#X Recessive
echo "X Recessive	X Recessive (Strict)" >> $CVL_macro
...
echo "X Recessive	X Recessive (Loose)" >> $CVL_macro
#cat ${X_RECESSIVE_OUT_LOOSE}_annotated.txt >> $CVL_macro
perl -ne 'print "X Recessive\t$_" unless /^gene\s+Gene_Name\s+OMIM_Phenotypes/' ${X_RECESSIVE_OUT_LOOSE}_annotated.txt >> $CVL_macro
...
#X Autosomal dominant
echo "X Dominant	X Autosomal Dominant (Strict)" >> $CVL_macro
...
echo "X Dominant	X Autosomal Dominant (Loose)" >> $CVL_macro
#cat ${X_DOMINANT_OUT_LOOSE}_annotated.txt >> $CVL_macro
perl -ne 'print "X Dominant\t$_" unless /^gene\s+Gene_Name\s+OMIM_Phenotypes/' ${X_DOMINANT_OUT_LOOSE}_annotated.txt >> $CVL_macro
...
# De novo low
echo "De Novo (Low)	De Novo Low (Strict)" >> $CVL_macro
#cat ${DENOVO_LOW_OUT}_annotated.txt >> $CVL_macro
perl -ne 'print "De Novo (Low)\t$_" unless /^gene\s+Gene_Name\s+OMIM_Phenotypes/' ${DENOVO_LOW_OUT}_annotated.txt >> $CVL_macro
...
perl -ne 'print "Non Coding - Cis Regulatory\t$_" unless /^gene\s+Gene_Name\s+OMIM_Phenotypes/' ${NONCODING_HITS}_annotated.txt >> $CVL_macro
