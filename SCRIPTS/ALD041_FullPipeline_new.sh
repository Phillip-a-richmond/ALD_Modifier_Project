#!/bin/bash
#PBS -N ALD041_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-data04/PROCESS/ALD_GENOME/ALD041/ALD041new.o
#PBS -e /mnt/causes-data04/PROCESS/ALD_GENOME/ALD041/ALD041new.e
#PBS -m bea
...
SAMPLE_ID='ALD041_BWAmem'
WORKING_DIR='/mnt/causes-data04/PROCESS/ALD_GENOME/ALD041/'
FASTQR1='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD041/ALD041_R1.fastq.gz'
FASTQR2='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD041/ALD041_R2.fastq.gz'
