#!/bin/bash
#PBS -N ALD059_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-data04/PROCESS/ALD_GENOME/ALD059/ALD059new.o
#PBS -e /mnt/causes-data04/PROCESS/ALD_GENOME/ALD059/ALD059new.e
#PBS -m bea
...
SAMPLE_ID='ALD059_BWAmem'
WORKING_DIR='/mnt/causes-data04/PROCESS/ALD_GENOME/ALD059/'
FASTQR1='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD059/ALD059_R1.fastq.gz'
FASTQR2='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD059/ALD059_R2.fastq.gz'
