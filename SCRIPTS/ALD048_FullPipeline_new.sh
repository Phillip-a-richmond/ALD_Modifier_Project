#!/bin/bash
#PBS -N ALD048_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-data04/PROCESS/ALD_GENOME/ALD048/ALD048new.o
#PBS -e /mnt/causes-data04/PROCESS/ALD_GENOME/ALD048/ALD048new.e
#PBS -m bea
...
SAMPLE_ID='ALD048_BWAmem'
WORKING_DIR='/mnt/causes-data04/PROCESS/ALD_GENOME/ALD048/'
FASTQR1='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD048/ALD048_R1.fastq.gz'
FASTQR2='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD048/ALD048_R2.fastq.gz'
