#!/bin/bash
#PBS -N ALD049_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-data04/PROCESS/ALD_GENOME/ALD049/ALD049new.o
#PBS -e /mnt/causes-data04/PROCESS/ALD_GENOME/ALD049/ALD049new.e
#PBS -m bea
...
SAMPLE_ID='ALD049_BWAmem'
WORKING_DIR='/mnt/causes-data04/PROCESS/ALD_GENOME/ALD049/'
FASTQR1='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD049/ALD049_R1.fastq.gz'
FASTQR2='/mnt/causes-data04/RAW/ALD_GENOME/1707KHX-0054_hdd1/ALD049/ALD049_R2.fastq.gz'
